...
#include "../sample/fnn/FNNReg.h"
#include "../sample/xor/xor.h"
#include "../sample/NiuXor/niuxor.h"
...
int main(int argc, const char ** argv)
{
	...
	if (argc > 1 && !strcmp(argv[1], "-test"))
		...
		xorMain(argc - 1, argv + 1);
	else if (argc > 1 && !strcmp(argv[1], "-niuxor"))
		niuxorMain(argc - 1, argv + 1);
	else {
